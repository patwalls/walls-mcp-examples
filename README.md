...
- [Add live web search to a Pydantic AI agent](https://superhighway.walls.sh/guides/web-search-pydantic-ai) — MCPServerStdio path or @agent.tool_plain with an API key
